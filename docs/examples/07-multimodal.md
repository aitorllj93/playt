# Example 7: Multimodal Output

Template that generates responses in multiple formats simultaneously.

## File: recipe-creator.md
...
const prompt = await render('recipe-creator.md', {
...
// Use with multimodal API (e.g., GPT-4 Vision, Claude)
const response = await multimodalAI.generate(prompt);

// Response would include:
// 1. Markdown text with complete recipe
// 2. Image of the finished dish
// 3. JSON with structured data
// 4. Image with visual step guide
```
...
A vibrant and nutritious bowl combining quinoa, roasted vegetables,
...
...
    ...
    },
    {
      type: 'image',
      format: 'png',
      url: 'https://...quinoa-bowl-hero.png',
      width: 1024,
      height: 1024
    },
    {
    ...
    },
    {
      type: 'image',
      format: 'png',
      url: 'https://...quinoa-bowl-steps.png',
      width: 800,
      height: 600
    }
  ]
...
1. **Cooking Blogs**: Complete content for posts
2. **Recipe Apps**: Structured data for database
3. **Cookbooks**: Ready-to-publish material
4. **Social Media**: Images and text to share
5. **Culinary Education**: Visual teaching material

## Features

- ✅ Multiple formats in a single response
- ✅ Coordinated and coherent components
- ✅ Text + Images + Structured data
- ✅ Detailed specifications per component
- ✅ Reusable for different dishes
- ✅ Complete and ready-to-use output
